...
export class AddressesComponent implements OnInit {
  ...
  constructor(public appService:AppService, public formBuilder: FormBuilder, public snackBar: MatSnackBar, public auth: AuthenticationService, public spinner: NgxSpinnerService) {}
  ...
  public async onShippingFormSubmit(values) {
    if (this.shippingForm.valid) {
        ...
        try{
            ...
            this.spinner.hide();
            this.snackBar.open('Error Saving New Address. '+err+'. Please try again later', '×', { panelClass: 'error', verticalPosition: 'top', duration: 3000 });
        }
